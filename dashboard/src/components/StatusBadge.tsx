const STATUS_LABELS: Record<string, string> = {
  ...
  NEEDS_QUESTIONS_PARTNER: 'Rückfragen Partner',
  NEEDS_QUESTIONS_BROKER: 'Rückfragen Broker',
  NEEDS_MANUAL_REVIEW_BROKER: 'Manuelle Prüfung',
  AWAITING_BROKER_CONFIRMATION: 'Warte auf Bestätigung',
